...
import com.example.webapi.resource.server.*;
...
public class WebApiApplication extends Application {
     ...
     */
    public static final String ROUTE_FINDPETBYTAGS = "/pet/findByTags";

    public static final String ROUTE_PET = "/pet/{petId}";

    public static final String ROUTE_PETLIST = "/pet";

    public static final String ROUTE_FINDPETBYSTATUS = "/pet/findByStatus";

    public static final String ROUTE_STOREORDER = "/store/order/{orderId}";

    public static final String ROUTE_STOREORDERLIST = "/store/order";

    public static final String ROUTE_USERLIST = "/user";

    public static final String ROUTE_CREATEUSERSWITHARRAY = "/user/createWithArray";

    public static final String ROUTE_CREATEUSERSWITHLIST = "/user/createWithList";

    public static final String ROUTE_USER = "/user/{userlogin}";
    ...
    public WebApiApplication() {
        setAuthor("yqd");
        setDescription("try to code with resources");
    	setName("jianyeDemo");
        setOwner("a56yun");
    ...
    public Router createApiRouter() {
        ...
        apiRouter.attach(ROUTE_USERLIST, UserListServerResource.class);
        apiRouter.attach(ROUTE_CREATEUSERSWITHARRAY, CreateUsersWithArrayServerResource.class);
